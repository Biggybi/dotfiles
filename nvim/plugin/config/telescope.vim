nnoremap <silent> yof            <cmd>Telescope file_browser<cr>
nnoremap <silent> <leader>ff     <cmd>Telescope find_files cwd=$HOME<cr>
nnoremap <silent> <leader>f.     <cmd>Telescope find_files cwd=$DOT<cr>
nnoremap <silent> <leader><c-f>  <cmd>Telescope find_files<cr>
nnoremap <silent> <leader>F      <cmd>Telescope find_files cwd=/<cr>
