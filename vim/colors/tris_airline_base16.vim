...
let s:gui_dark_gray = '#56b6c2'
" let s:cterm_dark_gray = 234
let s:cterm_dark_gray = 230
...
if get(g:, 'airline#themes#base16#constant', 0)
	...
	function! airline#themes#base16#refresh()
		...
		let s:I2 = airline#themes#get_highlight2(['Visual', 'fg'], ['Visual', 'bg'])
		let s:I3 = s:N3
		...
		let s:V2 = airline#themes#get_highlight2(['Visual', 'fg'], ['Visual', 'bg'])
