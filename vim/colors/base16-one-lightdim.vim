...
let g:base16_one_lightdim_shell = get(g:, 'base16_one_lightdim_shell',
      \'~/dotfiles/shells/themes/base16/base16-one-lightdim')
...
if !has("gui_running") && g:base16_noshell != 1
  if readfile('/home/tris/.config/base16_theme')[0]
        \!= matchstr(g:base16_one_lightdim_shell, '[^/]*$')
    execute "silent !source" g:base16_one_lightdim_shell
  endif
endif
...
call <sid>hi("MatchParen",    s:gui02, s:gui01,  "", "")
...
call <sid>hi("PMenuSbar",     s:gui04, s:gui03, "", "")
call <sid>hi("PMenuThumb",    s:gui01, s:gui01, "", "")
...
call <sid>hi("SuliGitSub",    s:gui0B, s:gui01, "none", "")
call <sid>hi("SuliGit",       s:gui0D, s:gui01, "none", "")
call <sid>hi("SuliCurDir",    s:gui0D, s:gui01, "none", "")
call <sid>hi("SuliGitMod",    s:gui08, s:gui03, "none", "")
...
" call <sid>hi("SuliCmd",     s:gui00, s:gui08, "none", "")
call <sid>hi("SuliPending",   s:gui00, s:gui06, "none", "")
call <sid>hi("SuliReplace",   s:gui00, s:gui08, "none", "")
...
call <sid>hi("SuliNormal",    s:gui00, s:gui04, "none", "")
call <sid>hi("SuliOuter",     s:gui05, s:gui03, "none", "")
call <sid>hi("SuliMid",       s:gui05, s:gui01, "none", "")
call <sid>hi("SuliSep",       s:gui00, s:gui01, "none", "")
call <sid>hi("StatusLineTermNC",    s:gui04, s:gui01, "none", "")
call <sid>hi("StatusLineTerm",      s:gui05, s:gui01, "none", "")
call <sid>hi("StatuslineNC",        s:gui04, s:gui01, "none", "")
" call <sid>hi("StatuslineNC",      s:gui05, s:gui01, "none", "")
