...
function! s:hl()
  ...
  call s:hi("QuickFixLine",  "", "01", "none", "")
  call s:hi("PMenu",         "05", "01", "none", "")
  call s:hi("PMenuSel",      "05", "03", "", "")
  call s:hi("PMenuSbar",     "04", "03", "", "")
  call s:hi("PMenuThumb",    "01", "01", "", "")

  call s:hi("TabLine",       "05", "02", "none", "")
  call s:hi("TabLineFill",   "05", "00", "none", "")
  call s:hi("TabLineSel",    "05", "03", "none", "")
  " Status Line
  call s:hi("SuliGitSub",    "0B", "01", "none", "")
  call s:hi("SuliGit",       "0D", "01", "none", "")
  call s:hi("SuliCurDir",    "0D", "01", "none", "")
  ...
  " call s:hi("SuliCmd",     "00", "08", "none", "")
  call s:hi("SuliPending",   "00", "06", "none", "")
  call s:hi("SuliReplace",   "00", "08", "none", "")
  ...
  call s:hi("SuliOuter",     "05", "03", "none", "")
  call s:hi("SuliMid",       "05", "01", "none", "")
  ...
  " call s:hi("StatuslineNC",      "05", "01", "none", "")
  ...
  " Diff highlighting
  call s:hi("DiffAdd",      "0B", "01", "", "")
  call s:hi("DiffChange",   "03", "01", "", "")
  call s:hi("DiffDelete",   "08", "01", "", "")
  call s:hi("DiffText",     "0D", "01", "", "")
  call s:hi("DiffAdded",    "0B", "01", "", "")
  call s:hi("DiffFile",     "08", "01", "", "")
  call s:hi("DiffNewFile",  "0B", "01", "", "")
  call s:hi("DiffLine",     "0D", "01", "", "")
  call s:hi("DiffRemoved",  "08", "01", "", "")
  ...
  call s:hi("SpellBad",     "", "", "undercurl", "08")
