...
let s:b = { "gui": "#383a42", "cterm": "237" }  "black
let s:r = { "gui": "#e45649", "cterm": "167" }  "red
let s:g = { "gui": "#50a14f", "cterm": "71" }   "green
let s:y = { "gui": "#c18401", "cterm": "136" }  "yellow
let s:B = { "gui": "#0184bc", "cterm": "31" }   "blue
let s:p = { "gui": "#a626a4", "cterm": "127" }  "purple
let s:c = { "gui": "#0997b3", "cterm": "31" }   "cyan
let s:w = { "gui": "#fafafa", "cterm": "231" }  "white
...
call s:h("SuliGitCurNC",  s:p, s:g2, "")
