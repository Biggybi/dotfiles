...
let g:base16_one_darker_shell = get(g:, 'base16_one_darker_shell',
      \'~/dotfiles/shells/themes/base16/base16-one-darker')
...
if !has("gui_running") && g:base16_noshell != 1
  if readfile('/home/tris/.config/base16_theme')[0]
        \!= matchstr(g:base16_one_darker_shell, '[^/]*$')
...
hi clear
syntax reset
let g:colors_name = "base16-one-darker"
...
call <sid>hi("OnlySearch",    s:gui02, s:gui06, "none", "")
...
call <sid>hi("PMenuSbar",     s:gui04, s:gui04, "", "")
...
" Status Line
call <sid>hi("SuliGitSub",       s:gui0C, s:gui01, "none", "")
call <sid>hi("SuliGit",          s:gui0A, s:gui01, "none", "")
call <sid>hi("SuliGitMod",       s:gui08, s:gui04, "none", "")
call <sid>hi("SuliFileMod",      s:gui08, s:gui01, "none", "")
call <sid>hi("SuliCurDir",       s:gui0C, s:gui01, "none", "")
...
call <sid>hi("SuliMid",          s:gui05, s:gui01, "none", "")
...
call <sid>hi("cDefine",           s:gui0E, "", "", "")
call <sid>hi("cCustomMacro",      s:gui0C, "", "", "")
call <sid>hi("cInclude",          s:gui0C, "", "", "")
call <sid>hi("cStructureMember",  s:gui03, "", "", "")
" call <sid>hi("cStorageClass",     s:gui08, "", "", "")
" call <sid>hi("cParen",            s:gui0A, "", "", "")
" call <sid>hi("cBlock",            s:gui0A, "", "", "")
" cStructureMember cParen cBlock cBlock cBlock
" C++
call <sid>hi("cppStructure",    s:gui0E, "", "", "")

" C# highlighting
call <sid>hi("csClassStorage",          s:gui0E, "", "", "")
call <sid>hi("csClass",                 s:gui0E, "", "", "")
call <sid>hi("csClassType",             s:gui0A, "", "", "")
call <sid>hi("csAttribute",             s:gui0A, "", "", "")
call <sid>hi("csModifier",              s:gui0E, "", "", "")
call <sid>hi("csType",                  s:gui0E, "", "", "")
...
call <sid>hi("CocSelectedLine", s:gui0E, s:gui0A, "", "")
call <sid>hi("CocSelectedText", s:gui0E, s:gui0A, "", "")

call <sid>hi("CocListMode", s:gui0B, s:gui04, "", "")
call <sid>hi("CocListPath", s:gui03, s:gui01, "", "")
