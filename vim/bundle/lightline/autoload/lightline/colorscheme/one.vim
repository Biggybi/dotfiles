...
"   let s:red1  = [ '#98c379', 35 ]
  let s:bg     = [ '#e0e0e0', 250 ]
  let s:gray1  = [ '#494b53', 238 ]
  let s:gray2  = [ '#c3c3c3', 255 ]
  let s:gray3  = [ '#b3b3b3', 250 ]
  let s:red1  = [ '#98c379', 35 ]

  let s:p.normal.left     = [ [ s:bg, s:red1, 'bold' ], [ s:gray1, s:gray3 ] ]
  ...
  let s:p.replace.left    = [ [ s:bg, s:green, 'bold' ], [ s:gray1, s:gray3 ] ]
