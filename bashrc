...
# fzf defaults
export FZF_DEFAULT_OPTS="-m --color='light' --height 40% --bind 'ctrl-u:preview-up,ctrl-d:preview-down,ctrl-o:toggle+up' --preview 'bat --style=numbers --color=always {} | head -500'"
